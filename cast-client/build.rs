...
fn main() {
    protobuf_codegen_pure::run(protobuf_codegen_pure::Args {
        out_dir: "src/proto",
        input: &["proto/authority_keys.proto", "proto/cast_channel.proto"],
        includes: &["proto"],
    ...
    StrReplace::from_file("src/proto/authority_keys.rs")
        .replace(
            "#![allow(clippy)]",
            "#![allow(clippy::all, clippy::pedantic)]",
        )
        .to_file("src/proto/authority_keys.rs");
    StrReplace::from_file("src/proto/cast_channel.rs")
        .replace(
            "#![allow(clippy)]",
            "#![allow(clippy::all, clippy::pedantic)]",
        )
        .to_file("src/proto/cast_channel.rs");
}
